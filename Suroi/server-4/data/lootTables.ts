...
export type WeightedItem = ({ readonly item: ReferenceTo<LootDefinition> | null } | { readonly tier: string }) & {
...
export const LootTables: Record<string, LootTable> = {
  ground_loot: {
    ...
    loot: [
      ...
      { tier: "naders_equipment", weight: 0.75 }, 
  ...
  lux_crate: {
    min: 1,
    max: 1,
    loot: [[{ item: "cz600", weight: 1 }], [{ tier: "scopes", weight: 1 }]],
  },
  gold_rock: {
    min: 1,
    max: 1,
  ...
  airdrop_crate: {
    ...
    loot: [
      ...
      [
        { item: "frag_grenade", count: 6, weight: 2 },
        { item: null, weight: 1 },
      ],
    ],
  },
  ...
  flint_stone: {
    min: 1,
    max: 1,
    loot: [{ tier: "gold_airdrop_guns", weight: 1 }],
  },
  christmas_tree: {
    min: 4,
    max: 5,
  ...
  gun_case: {
    min: 1,
    max: 2,
    loot: [{ tier: "special_guns", weight: 1 }],
  },
  ammo_crate: {
    min: 1,
    max: 1,
...
export const LootTiers: Record<string, WeightedItem[]> = {
  ...
  throwables: [
    { item: "frag_grenade", count: 6, weight: 1 },
    { item: "smoke_grenade", count: 3, weight: 1 },
  ],
  special_guns: [
