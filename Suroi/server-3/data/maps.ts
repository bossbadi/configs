...
export const Maps: Record<string, MapDefinition> = {
  main: {
    ...
    buildings: {
      ...
      mobile_home: 0,
      porta_potty: 3,
      container_3: 5, // green one way
      container_4: 5, // green one-way large hole
      container_5: 5, // blue one-way
      container_6: 5, // blue one-way large hole
      container_7: 5, // blue two-way
      container_8: 5, // blue two-way small hole
      container_9: 5, // yellow one-way
      container_10: 5, // yellow two-way
    },
    obstacles: {
      oil_tank: 0,
    ...
    places: [
      { name: "Bloodbath", position: Vec.create(0.6, 0.3) },
      { name: "Ur Mom", position: Vec.create(0.25, 0.5) },
      { name: "Unflushed Toilet", position: Vec.create(0.7, 0.7) },
    ],
  },
  debug: {
    width: 1620,
  ...
  arena: {
    ...
    places: [{ name: "stark is noob", position: Vec.create(0.5, 0.5) }],
  },
  singleBuilding: {
    width: 1024,
    height: 1024,
    ...
    genCallback(map) {
      for (let i = 0; i < Guns.length; i++) {
        const player = new Player(
          ...
          } as unknown as WebSocket<PlayerContainer>,
